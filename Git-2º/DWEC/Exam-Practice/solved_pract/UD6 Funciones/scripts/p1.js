// Primero se piden las palabras al usuario
...
/*
Recibe un listado de palabras en un array, elimina las duplicadas y
devuelve el listado ordenado alfabéticamente de forma inversa
*/
function ordenaPalabras(listado) {
    const listaNoRep = new Set(listado);
    return [...listaNoRep].sort((elem1, elem2) => -elem1.localeCompare(elem2,'es'));
}